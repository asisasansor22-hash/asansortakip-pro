...
function BakimciGorunum({elevs,maints,setMaints,faults,setFaults,kalanEskiDevir,yeniDevir,ilceler,today,fMonth,setFMonth,eName,sonOdemeler,setSonOdemeler,aktifBakimci,rotaData}){
