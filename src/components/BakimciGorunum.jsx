...
function BakimciGorunum({elevs,maints,setMaints,faults,setFaults,bal,kalanEskiDevir,yeniDevir,ilceler,today,fMonth,setFMonth,eName,sonOdemeler,setSonOdemeler,aktifBakimci}){
