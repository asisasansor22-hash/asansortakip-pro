          ...
          , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(270px,1fr))",gap:8},}
            , es.map(e=>{
              ...
              return React.createElement('div', { key: e.id, style: {background:eBakimYapildi?"#0d1f12":"#141824",borderRadius:12,border:"1px solid "+(eBakimYapildi?"#10b981":"#2a3050"),borderTop:"3px solid "+(eBakimYapildi?"#10b981":c),padding:13},}
                ...
                /* BAKIM GÜNÜ: her ayın kaçında bakım yapılıyor */
                , (function(){
                    var gun=(e.bakimGunu!=null&&String(e.bakimGunu).trim()!==""&&String(e.bakimGunu)!=="0")?String(e.bakimGunu).trim():null;
                    if(!gun) return null;
                    return React.createElement('div',{style:{marginTop:6,marginBottom:2}},
                      React.createElement('span',{style:{fontSize:11,fontWeight:800,padding:"3px 9px",borderRadius:6,background:"#1e2a45",color:"#93c5fd"}},
                        "📅 Bakım Günü: Her ayın "+gun+"'i")
                    );
                  })()
                , (function(){
