...
- **Uygulama kilidi (PIN):** Açılışta ve arka plandan dönüşte 4 haneli PIN iste; telefonu birine verince harcamaların gizli kalsın. PIN **cihaza özeldir**, buluta gönderilmez.
...
4. Artık ana ekranda **Spendy** ikonu var; normal uygulama gibi tam ekran açılır.
...
- İstersen **4 haneli PIN kilidi** aç (Ayarlar → *Uygulama kilidi*); uygulama her açılışta ve arka plandan dönüşte PIN ister. PIN yalnızca o cihazda saklanır, yedeğe/buluta dahil edilmez.
