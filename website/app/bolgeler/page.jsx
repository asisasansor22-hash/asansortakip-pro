...
export const metadata = {
  ...
  description: "Asis Asansör İstanbul Avrupa Yakası hizmet bölgeleri."
};

export default function AreasPage() {
  return (
    <main>
      <section className="page-hero"><div className="container"><div className="breadcrumb">Ana Sayfa / Bölgeler</div><h1>İstanbul Avrupa Yakası'nda aktif servis.</h1><p className="lead">Yenibosna merkezli ekiplerimizle Avrupa Yakası'ndaki apartman, site ve işletmelere bakım ve arıza desteği sağlıyoruz.</p></div></section>
