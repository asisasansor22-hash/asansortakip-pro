...
export default function ContactPage() {
  ...
  return (
    <main>
      <section className="page-hero"><div className="container"><div className="breadcrumb">Ana Sayfa / İletişim</div><h1>Servis, teklif ve bakım talebi için ulaşın.</h1><p className="lead">Asis Asansör ofisi Bahçelievler'dadır. Telefon, WhatsApp veya form üzerinden hızlıca iletişime geçebilirsiniz.</p></div></section>
      ...
      <section className="section alt"><div className="container split"><ContactForm /><Reveal><div className="eyebrow">Ofis</div><h2>Zafer Mahallesi, Bahçelievler.</h2><p className="lead">{contact.address}</p><iframe className="map-frame" title="Asis Asansör konum haritası" loading="lazy" src={mapSrc} /></Reveal></div></section>
    </main>
  );
}
