...
const CURATED = [
  ...
  { id: "dumbbell-fly", name: "Dumbbell Fly", region: "gogus", anim: "fly", equip: "Dumbbell", level: "Orta",
  ...
  { id: "cable-crossover", name: "Cable Crossover", region: "gogus", anim: "fly", equip: "Makine", level: "Orta",
    sets: "3 x 15", desc: "Makarada kolları önde birleştirerek göğsü sıkıştırır.", tips: ["Hafif öne eğil", "Tepede sık"] },
  { id: "chest-dips", name: "Dips (Göğüs)", region: "gogus", anim: "dip", equip: "Paralel bar", level: "İleri",
  ...
  { id: "barbell-row", name: "Barbell Row", region: "sirt", anim: "row", equip: "Halter", level: "Orta",
    sets: "4 x 10", desc: "Öne eğilip halteri karına çek. Sırt kalınlığı için temel.", tips: ["Bel düz kalsın", "Dirsekleri geriye çek"] },
  { id: "dumbbell-row", name: "Dumbbell Row", region: "sirt", anim: "row", equip: "Dumbbell", level: "Başlangıç",
    sets: "3 x 12", desc: "Tek kol dumbbell çekişi; sırt kası izolasyonu.", tips: ["Sehpaya yaslan", "Yukarı çek"] },
  { id: "t-bar-row", name: "T-Bar Row", region: "sirt", anim: "row", equip: "Makine", level: "Orta",
    sets: "4 x 10", desc: "Orta sırt yoğunluğu için kalın tutuşlu çekiş.", tips: ["Göğsü dik tut"] },
  { id: "seated-row", name: "Seated Cable Row", region: "sirt", anim: "row", equip: "Makine", level: "Başlangıç",
  ...
  { id: "lateral-raise", name: "Yan Kaldırış", region: "omuz", anim: "lateralraise", equip: "Dumbbell", level: "Başlangıç",
  ...
  { id: "rear-delt-fly", name: "Arka Omuz Fly", region: "omuz", anim: "fly", equip: "Dumbbell", level: "Orta",
  ...
  { id: "triceps-pushdown", name: "Triceps Pushdown", region: "kol", anim: "pushdown", equip: "Makine", level: "Başlangıç",
    sets: "3 x 15", desc: "Makarada barı aşağı iterek triceps çalıştırır.", tips: ["Dirsekleri gövdeye sabitle"] },
  { id: "overhead-extension", name: "Overhead Triceps Ext.", region: "kol", anim: "tricepsext", equip: "Dumbbell", level: "Orta",
    sets: "3 x 12", desc: "Baş üstünde ağırlığı uzatarak triceps uzun başı.", tips: ["Dirsekler sabit", "Tam uzat"] },
  { id: "skull-crusher", name: "Skull Crusher", region: "kol", anim: "tricepsext", equip: "Halter", level: "Orta",
    sets: "3 x 10", desc: "Yatarak barı alına indirip uzatma; triceps.", tips: ["Dirsekleri sabit tut"] },
  { id: "triceps-dips", name: "Dips (Triceps)", region: "kol", anim: "dip", equip: "Vücut ağırlığı", level: "Orta",
  ...
  { id: "leg-extension", name: "Leg Extension", region: "bacak", anim: "legextension", equip: "Makine", level: "Başlangıç",
  ...
  { id: "leg-curl", name: "Leg Curl (Hamstring)", region: "bacak", anim: "legcurl", equip: "Makine", level: "Başlangıç",
    sets: "3 x 15", desc: "Arka bacak (hamstring) izolasyonu.", tips: ["Tam büküp aç"] },
  { id: "hip-thrust", name: "Hip Thrust", region: "bacak", anim: "hipthrust", equip: "Halter", level: "Orta",
  ...
  { id: "pec-deck", name: "Pec Deck (Butterfly)", region: "gogus", anim: "fly", equip: "Makine", level: "Başlangıç",
    sets: "3 x 15", desc: "Makinede kolları önde birleştirerek göğüs izolasyonu.", tips: ["Tepede sık", "Yavaş aç"] },
  { id: "squeeze-press", name: "Sıkma Pres (Squeeze/Crush Press)", region: "gogus", anim: "benchpress", equip: "Dumbbell", level: "Orta",
    sets: "3 x 10-12", desc: "Sırt üstü yatıp iki dumbbell'ı birbirine BASTIRARAK press yaparsın. Dumbbell'lar hareketin tamamı boyunca temas hâlinde kalır; bu sıkıştırma göğsün addüksiyon görevini kilit noktada — kollar birleşikken — yüklü tutar. Normal presin en kolay olduğu yer burasıdır, sıkma presin en zor olduğu yer.",
    tips: ["Dumbbell'ları TÜM set boyunca birbirine bastır", "Nötr tutuş (avuçlar karşı karşıya)", "Ağırlık düşük tut; belirleyici olan sıkma", "Tepede 1 sn ekstra sık"] },
  // sırt
  ...
  { id: "v-bar-pulldown", name: "V-Bar Pulldown", region: "sirt", anim: "row", equip: "Makine", level: "Başlangıç",
    sets: "4 x 12", desc: "Dar tutuşla orta sırt yoğunluğu.", tips: ["Göğse çek", "Sallanma"] },
  // omuz
  { id: "face-pull", name: "Face Pull", region: "omuz", anim: "row", equip: "Makine", level: "Başlangıç",
    sets: "3 x 15", desc: "Halatı yüze çekerek arka omuz ve postür.", tips: ["Dirsek yüksek", "Sık"] },
  { id: "cable-lateral", name: "Cable Yan Kaldırış", region: "omuz", anim: "lateralraise", equip: "Makine", level: "Başlangıç",
  ...
  { id: "triceps-kickback", name: "Triceps Kickback", region: "kol", anim: "pushdown", equip: "Dumbbell", level: "Başlangıç",
  ...
  { id: "glute-bridge", name: "Glute Bridge", region: "bacak", anim: "hipthrust", equip: "Vücut ağırlığı", level: "Başlangıç",
  ...
  // Çekme
  { id: "inverted-row", name: "Avustralya Barfiksi (Inverted Row)", region: "sirt", anim: "row", equip: "Bar", level: "Başlangıç",
  ...
  { id: "nordic-curl", name: "Nordic Hamstring", region: "bacak", anim: "legcurl", equip: "Vücut ağırlığı", level: "İleri",
  ...
  { id: "single-leg-glute-bridge", name: "Tek Bacak Glute Bridge", region: "bacak", anim: "hipthrust", equip: "Vücut ağırlığı", level: "Başlangıç",
...
export const ALTERNATIVES = {
  ...
  "cable-crossover": ["dumbbell-fly", "pec-deck", "Low_Cable_Crossover"],
  "pec-deck": ["dumbbell-fly", "cable-crossover"],
  "dumbbell-fly": ["pec-deck", "cable-crossover"],
  // Addüksiyon (sıkıştırma) ailesi — hepsi kollar birleşikken gerilimi koruyor
  "squeeze-press": ["Svend_Press", "pec-deck", "dumbbell-press"],
  "Svend_Press": ["squeeze-press", "Isometric_Chest_Squeezes", "pec-deck"],
  "Isometric_Chest_Squeezes": ["Svend_Press", "squeeze-press"],
  "chest-dips": ["sinav", "archer-pushup", "wide-pushup"],
  ...
  "front-raise": ["shoulder-press", "arnold-press", "pike-pushup"],
  "face-pull": ["rear-delt-fly"],
  "rear-delt-fly": ["face-pull"],
  "upright-row": ["lateral-raise", "cable-lateral"],
  "shrug": ["barbell-row", "seated-row"],
  // kol
  ...
  "triceps-dips": ["triceps-pushdown", "diamond-pushup", "overhead-extension"],
  // bacak
  ...
  "leg-curl": ["nordic-curl", "romanian-deadlift", "good-morning"],
  ...
  "box-jump": ["jump-squat", "skater"],
  // kalistenik (muadiller: alet yoksa / zorluk ayarı)
  "wide-pushup": ["sinav", "decline-pushup", "chest-dips"],
  "decline-pushup": ["sinav", "archer-pushup", "wide-pushup"],
  "archer-pushup": ["sinav", "wide-pushup", "decline-pushup"],
  "pseudo-planche-pushup": ["archer-pushup", "sinav", "decline-pushup"],
  ...
  "muscle-up": ["barfiks", "negative-pullup", "chin-up"],
  "pistol-squat": ["bulgarian", "squat", "wall-sit"],
  "wall-sit": ["squat", "leg-extension", "goblet-squat"],
  "nordic-curl": ["leg-curl", "romanian-deadlift", "good-morning"],
  ...
  "superman": ["hyperextension", "good-morning"],
};
...
// ---- Doğru form + açı + kası daha etkili çalıştırma (kısa) ----
export const FORM = {
  // GÖĞÜS
  "bench-press": "Kürekleri geri-aşağı sık, hafif sırt kavisi, ayaklar yerde. Bar meme hizasına insin; dirsekler gövdeyle ~45-75° (90° açma — omuz için). İtişte göğsü sıkarak yukarı sür.",
  "incline-press": "Sehpa 30-45° (fazlası omuza kaçar). Bar üst göğse insin, dirsekler ~45°. Tepede clavicular lifleri sıkıştır.",
  "decline-press": "15-30° aşağı eğim. Bar alt göğse insin, dirsekler gövdeye yakın. Alt göğüs (abdominal) lifleri hedef.",
  "dumbbell-press": "Dumbbell'lar göğüs hizasından derin insin (bardan geniş açı = daha çok gerilme). Dirsek ~45°, tepede yaklaştır ama tokuşturma.",
  "dumbbell-fly": "Dirsekler hafif sabit-kırık (~15°), kolları yay gibi aç. Germede göğüste gerilim, tepede adduksiyonla 1 sn sık.",
  "sinav": "Baştan topuğa düz çizgi, kalça düşmesin (core sıkı). Eller omuz hizası, dirsekler ~45° açılsın. Göğsü yere yaklaştır, tam kilitleme.",
  "diamond-pushup": "Eller göğüs altında elmas; dirsekleri gövdeye yakın kaydır. İç göğüs + triceps (medial baş) için tam in-çık.",
  "incline-pushup": "Eller yüksek yüzeyde, vücut düz. Kolay varyasyon; alt göğüs vurgusu.",
  "cable-crossover": "Hafif öne eğil, dirsek sabit-kırık. Kabloları önde alt-orta hizada birleştir ve 1 sn sık. Sürekli gerilim göğsü izole eder.",
  "chest-dips": "Öne ~30° eğil, dirsek hafif dışa; omuz çizgisine kadar in, çok derine gitme. Öne eğim = alt göğüs.",
  "incline-dumbbell-press": "30-45° eğim, dumbbell üst göğse; dirsek ~45°, tepede sık.",
  "machine-chest-press": "Tutamak göğüs ortası hizasında, omuz geride. Tam aç-kapa, dirsek kilitleme.",
  "pec-deck": "Kol/dirsek yastığa sabit, omuz hizasında. Önde 1 sn sık, yavaş aç. Saf izolasyon.",
  "squeeze-press": "Sırt üstü düz sehpa (ya da 15-30° eğim). Nötr tutuş, dumbbell'lar TÜM set boyunca birbirine bastırılmış. Dirsek gövdeyle ~30-45° (dar); göğüs ortasına indir, tepede 1 sn ekstra sık. Ağırlık düşük — belirleyici olan sıkma kuvveti.",
  "Svend_Press": "Ayakta, plaka iki avuç arasında göğüs hizasında sıkılı. Dirsek hafif bükük, omuz geride; plakayı düz öne it, kolları uzatınca 1-2 sn sık. 5-10 kg yeterli.",
  "Isometric_Chest_Squeezes": "Avuçları göğüs önünde birleştir, birbirine bastır ve 10-20 sn tut. Dirsekler omuz hizasında; ekipmansız addüksiyon çalışması.",
  "Low_Cable_Crossover": "Makaralar EN ALTTA. Kabloları aşağıdan yukarı-içeri, göğüs üstü hizasında birleştir; dirsek sabit-kırık. Alttan yukarı açı üst göğüs liflerini vurgular.",
  "Around_The_Worlds": "Sırt üstü, kollar düz-sabit; dumbbell'ları kalçadan başın üstüne yarım daire çizerek götür. Hafif ağırlık — omuz için riskli bir hareket, kontrolü kaybetme.",
  "wide-pushup": "Eller omuzdan geniş; dış göğüs vurgusu. Dirsekler kontrollü, kalça sabit.",
  "decline-pushup": "Ayaklar yüksekte, vücut düz. Üst göğüs + ön omuz; kalça düşmesin.",
  "archer-pushup": "Ağırlığı tek kola ver, diğer kol düz yana. Yükü çalışan kolda tut; tek kol şınava köprü.",
  "pseudo-planche-pushup": "Eller bel hizasında, gövde öne eğik, omuzları öne it. Ön omuz + iç göğüs; planş hazırlığı.",
  // SIRT
  "barfiks": "Tam asıl (kollar düz), göğsü bara doğru sür. Sırtla çek — önce kürekleri aşağı-geri, sonra dirsek. Çeneyi bar üstüne, kontrollü in.",
  "chin-up": "Avuçlar sana dönük (supinasyon); biceps + lat. Göğsü bara götür, tam aşağı uzan.",
  "lat-pulldown": "Hafif geriye yaslan (~15°), göğsü kaldır. Barı göğüs üstüne çek, dirsekleri aşağı-geri sür. Sallanma.",
  "barbell-row": "Kalçadan menteşe, gövde ~45° öne, bel düz. Barı göbeğe çek, dirsek gövdeye yakın; kürekleri sık.",
  "dumbbell-row": "Sehpaya destek, sırt düz-yatay. Dumbbell'ı kalçaya doğru çek, dirsek gövdeye yakın; tepede lat'ı sık.",
  "t-bar-row": "Göğüs dik, bel nötr, hafif diz kırık. Kalın tutuşla göbeğe çek; orta sırt yoğunluğu.",
  "seated-row": "Dik otur, omuzları geriye al, beli sabit. Göbeğe çek, kürekleri sık; öne dönerken gövdeyi savurma.",
  "deadlift": "Bar bileğe yakın, sırt nötr (yuvarlanma). İtişi topuktan başlat, kalça ve omuz aynı anda kalksın; bara kalçayla yaklaş, çene içeride.",
  "romanian-deadlift": "Dizler hafif kırık-sabit, kalçayı geriye it. Bar bacağa değecek kadar yakın insin; hamstring gerilince geri kalk. Bel düz.",
  "good-morning": "Hafif diz kırık, kalça menteşesi; bar sırtta. Gövdeyi öne indir, bel düz; hamstring gerilince kalça öne it.",
  "hyperextension": "Kalçadan bük, bel nötr. Gövdeyi hizaya kadar kaldır — aşırı geriye (hiperekstansiyon) gitme; glute+bel sık.",
  "rack-pull": "Bar diz hizasından; sırt nötr, göğüs dik. Kalçayı öne iterek kilitle; üst sırt/trapez.",
  "v-bar-pulldown": "Dar nötr tutuş, göğsü kaldır, göğse çek. Alt lat liflerine daha çok yüklenir.",
  "inverted-row": "Vücut düz (topuk-omuz çizgi), bara asıl. Göğsü bara değdir, kürekleri sık; ayak öne = zorlaşır.",
  "scapular-pull": "Kolları düz tut, sadece kürekleri aşağı-geri çek (omuzları kulaktan uzaklaştır). Barfiks için sırt-omuz bağı.",
  "negative-pullup": "Çene bar üstündeyken 3-5 sn yavaşça in. Eksantrik güç kazanmanın en etkili yolu.",
  "muscle-up": "Patlayıcı çekiş + bileği çevirip dipe geç. Önce barfiks ve dips ayrı ayrı güçlensin.",
  "superman": "Yüzüstü, kol-bacak yukarı; tepede 1-2 sn dur. Boynu zorlama; bel (erector) + glute.",
  // OMUZ
  "shoulder-press": "Core sıkı, beli yaylandırma. Ağırlığı baş üstüne dikey it, dirsek tam aç (kilitleme); iniş çene hizasına.",
  "military-press": "Ayakta, karın+glute sıkı. Bar çene hizasından çıkar, baş hafif geri; tepede başın üstünde hizala.",
  "arnold-press": "Avuç içeri başla, iterken dışa döndür. Anterior→lateral delt; yavaş döndür.",
  "lateral-raise": "Dirsek hafif kırık, kolları yanlara aç. Omuz yüksekliğinde dur (fazlası trapeze kaçar); baş parmağı hafif aşağı, kontrollü indir.",
  "front-raise": "Kolu öne omuz hizasına kaldır, dirsek hafif kırık. Sallanma; ön deltoid izolasyon.",
  "rear-delt-fly": "Öne eğil, dirsek hafif kırık, kolları yana aç. Hafif ağırlık, tepede sık; arka delt.",
  "upright-row": "Barı çeneye doğru dik çek, dirsek yüksekte kalsın. Bilek ağrısı olursa geniş tut; yan omuz + trapez.",
  "cable-lateral": "Kablo alttan, sabit gerilim. Kolu yana omuz hizasına kaldır, kontrollü indir.",
  "face-pull": "Halatı yüz/alın hizasına çek, dirsek yüksek, dışa aç. Arka delt + orta trapez; postür için ideal.",
  "shrug": "Omuzları düz yukarı silk (yuvarlama), tepede 1 sn sık. Trapez üst lifleri.",
  "pike-pushup": "Kalça yukarı ters V, başı ellerin önüne indir. Dirsekleri çok açma; amuda şınava hazırlık.",
  "handstand-pushup": "Duvar desteği, core+glute sıkı, kontrollü in. Güçlü omuz presi.",
  // KOL
  "biceps-curl": "Dirsek gövdeye sabit (öne kaymasın), sadece ön kol dönsün. Tepede sık, yavaş indir; sallanma.",
  "barbell-curl": "Dirsekleri sabitle, barı omuza kaldır. Sırtı savurma; bicepsi tam kısalt.",
  "hammer-curl": "Nötr tutuş (avuç içe). Dirsek sabit; brachialis + brachioradialis (kol kalınlığı).",
  "concentration-curl": "Dirseği iç uyluğa yasla, tam izole et. Tepede peak sıkışma; kısa baş vurgusu.",
  "preacher-curl": "Kol yastıkta sabit, tam aşağı in (biceps gerilsin), kontrollü kaldır. Kısa baş.",
  "spider-curl": "Eğimli sehpaya yüzükoyun, kol dik sarksın; tam kasılmada sık. Sallanma yok.",
  "cable-hammer-curl": "Halat, nötr tutuş, sabit gerilim; dirsek sabit.",
  "zottman-curl": "Yukarı normal (avuç yukarı), tepede bileği çevir, aşağı ters tutuşla in. Brachioradialis + biceps.",
  "triceps-pushdown": "Dirsekleri gövdeye sabitle, sadece ön kol insin; altta tam uzat. Dış baş.",
  "overhead-extension": "Ağırlık baş üstünde, dirsek sabit-yukarı; arkada gerilene kadar in, uzat. Uzun baş (germede güçlü).",
  "skull-crusher": "Yat, üst kol dik-sabit; barı alına/arkaya indir, dirsekle uzat. Uzun baş.",
  "triceps-dips": "Gövde dik (öne eğilme = göğüs), dirsek geride; 90°'ye kadar in. Triceps bileşik.",
  "close-grip-bench": "Omuz genişliğinden dar tut, dirsek gövdeye yakın. Barı alt göğse; triceps ağırlıklı bileşik.",
  "triceps-kickback": "Öne eğil, üst kol gövdeye paralel-sabit; kolu geriye tam uzat, tepede sık.",
  // BACAK
  "squat": "Ayak omuz genişliği, parmaklar hafif dışa. Kalçayı geriye+aşağı, diz parmak ucu yönünde; en az uyluk yatay derinlik, sırt nötr, göğüs dik.",
  "front-squat": "Bar ön omuzda, dirsekler yukarı, gövde dik. Quadriceps + core; derin ve kontrollü.",
  "goblet-squat": "Dumbbell göğüs önünde, dirsek içeride. Derin çök, topuklar yerde; başlangıç dostu.",
  "leg-press": "Ayaklar platform ortasında, sırt yaslı. Dizi göğse yaklaştır (bel kalkmadan), dizi kilitleme.",
  "leg-extension": "Sırt yaslı, diz eksene hizalı; tepede quadricepsi sık, yavaş indir. İzolasyon.",
  "lunge": "Öne adım, gövde dik; arka diz yere yaklaşsın, ön diz parmak ucunu geçmesin. Topukla it.",
  "bulgarian": "Arka ayak yükseltilmiş, gövde hafif öne; ön bacakla derin in. Denge + quad/glute.",
  "step-up": "Tüm ayağı platforma bas, topukla itip yüksel; öbür bacakla itme. Kontrollü in.",
  "pistol-squat": "Tek bacak, karşı bacak önde düz; topuk yerde, derin çök. Önce destekli dene.",
  "wall-sit": "Sırt duvarda düz, diz 90°, uyluk yere paralel. İzometrik quad tutuşu; nefes al.",
  "hack-squat": "Sırt desteğe yaslı, ayaklar önde. Derin in, quadriceps (vastuslar) odak.",
  "leg-curl": "Kalça sabit, topuğu kalçaya çek (diz fleksiyonu); tepede hamstringi sık, yavaş aç.",
  "nordic-curl": "Diz çökük, ayaklar sabit; gövdeyi tek parça düz tutarak çok yavaş öne bırak (kalça menteşe yapma), elle iterek geri kalk. En güçlü eksantrik hamstring.",
  "hip-thrust": "Sırt üstü bir sehpaya yaslı, çene içeride. Kalçayı yukarı it, tepede glute'u sık; bel değil kalça çalışsın.",
  "glute-bridge": "Sırt üstü, topuklar kalçaya yakın; kalçayı yukarı it, tepede sık.",
  "sumo-deadlift": "Geniş duruş, parmaklar dışa, eller içeride. Göğüs dik, bara yakın; iç bacak + glute.",
  "glute-kickback": "Gövde sabit, bacağı geriye tam uzat; tepede glute'u sık, beli koru.",
  "single-leg-glute-bridge": "Tek bacakla kalçayı eşit kaldır, tepede sık; kalça bir yana düşmesin.",
  "calf-raise": "Diz DÜZ (gastrocnemius), topukları tam kaldır, tepede 1 sn dur, tam aşağı ger.",
  "seated-calf-raise": "Diz BÜKÜK (soleus), tam aralıkta çalış; tepede dur, kontrollü in.",
  // KARIN
  "crunch": "Sadece üst gövdeyi kıvır (bel yerde), karnı sık; boynu elle çekme, çeneyi göğse yapıştırma.",
  "situp": "Tam gövde kalkışı, kontrollü; beli koru, momentumla savurma.",
  "leg-raise": "Beli yere yapıştır, bacakları kontrollü kaldır-indir; bel boşluk yaparsa dizleri hafif kır. Alt karın.",
  "reverse-crunch": "Kalçayı yukarı sararak dizleri göğse; sallanma, kontrollü. Alt karın.",
  "flutter-kicks": "Bel yerde sabit, bacakları düz sırayla çırp; alt karın + kalça fleksörü.",
  "hanging-leg-raise": "Bara asıl, sallanma; bacakları kontrollü kaldır (düz = zor, diz çekili = kolay). Güçlü alt karın.",
  "bicycle-crunch": "Çapraz dirsek-diz, yavaş ve kontrollü; oblikler için rotasyonu tam yap.",
  "russian-twist": "Gövdeyi sağa-sola çevir, ağırlığı kalça yanına götür; ayaklar havada zorlaşır. Oblik.",
  "side-plank": "Dirsek omuz altında, vücut yandan düz; kalçayı düşürme. Oblik + yan stabilizasyon.",
  "plank": "Dirsek omuz altında, baştan topuğa düz; kalça yukarı/aşağı kaçmasın, karın+glute sıkı. Nefesi tutma.",
  "hollow-body-hold": "Bel yere yapışık, omuz ve bacak hafif havada içbükey; nefesi tutma. Jimnastik core temeli.",
  "l-sit": "Omuzları aşağı bas, bacakları düz L'de tut; önce diz çekili (tuck) dene.",
  "toe-touches": "Bacaklar havada düz, el-ayak ucuna uzan; karnı sık, boynu zorlama.",
  "v-up": "Kol ve bacağı aynı anda kaldırıp V yap; kontrollü kalk-in, sallanma.",
  "ab-roller": "Karın+glute sıkı, bel çökmesin; kontrollü aç, karınla topla. Anti-ekstansiyon.",
  "dragon-flag": "Omuzdan destek, vücut tek parça düz; çok yavaş indir, bel çökmesin. İleri core.",
  "mountain-climber-ab": "Plank pozu, kalça sabit; dizleri sırayla göğse hızlı çek.",
  "cable-crunch": "Diz çök, halat ense/şakak hizasında sabit. Kalça sabit kalsın — sadece omurgayı KARINLA kıvır (kalçadan bükersen sırt hareketi olur). Altta 1 sn sık.",
  // KARDİYO
  "jumping-jack": "Ayaklar bitişik başla; kolları yandan baş üstüne, ayakları omuz genişliğinden dışa aç. Dizler yumuşak, ayak ucuna in.",
  "high-knees": "Dizi kalça hizasına (uyluk yere paralel) kaldır, gövde dik. Kollar aktif; ayak ucunda kal, topuğa çakma.",
  "butt-kicks": "Topuğu kalçaya değdir, uyluk dikey kalsın (dizi öne getirme). Gövde dik, hamstringi ısıtır.",
  "burpee": "Squat → eller yere → şınav pozuna sıçra → şınav → dizleri topla → yukarı sıçra. Bel çökmesin, iniş dizde yumuşak.",
  "jump-squat": "Squat derinliğine in (uyluk ~yatay), patlayıcı sıçra. İnişte dizler parmak ucu yönünde, diz içe kaçmasın; ayak ucundan topuğa yumuşak in.",
  "box-jump": "Kalçadan yükle, kolları savurarak sıçra. Kutunun TAM üstüne, çeyrek squat pozunda in — kilitlenerek inme. Aşağı sıçrama, adımla in.",
  "mountain-climber": "Eller omuz altında, baştan topuğa düz. Kalça yukarı kaçmasın; dizleri sırayla göğse hızlı çek.",
  "skater": "Yana sıçrayıp aynı taraf ayakla in, öbür bacağı arkaya çapraz al. Diz parmak ucu yönünde, yumuşak iniş.",
  "jump-rope": "Bileğinden çevir (koldan değil), 2-3 cm sıçra, ayak ucunda kal. Dirsekler gövdeye yakın.",
  "stairmaster": "Dik dur, korkuluğa YASLANMA (yaslanmak yükü kaldırır). Tüm ayağı basamağa bas, topukla it; kalça ve quad çalışsın.",
};
export function formOf(id) { return FORM[id] || null; }
