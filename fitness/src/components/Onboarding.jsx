  ...
  return (
    <div className="onboarding">
      <div className="onboarding-inner">
        <div className="brand" style={{ fontSize: 26, textAlign: "center" }}>GYM<span style={{ color: "var(--accent)" }}>O</span></div>
        <div className="brand-tag" style={{ textAlign: "center" }}>Gym Obsession</div>
